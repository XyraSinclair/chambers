...
```
python3 -m chambers.ip_trade_sim.run          # deterministic scenario
python3 -m unittest chambers.ip_trade_sim.test_engine -v
```

Per-lane court files land under `chambers/.chamber/ip_trades/<lane>/`.
