...
- Canonical type-signature lens: `docs/ideation/06-canonical-type-signatures.md`.
- Current primitive modules: `docs/primitives/{core,entropy,environment,attention,market,index}.ts`.
- Market and egress lenses: `docs/ideation/02-private-cognitive-labor-market.md`, `docs/ideation/03-egress-and-immune-system.md`.
- Prior kernel canon: the archived first-stab kernel's canon (private archive).
- Research memo and external anchors: `docs/research/canonical-type-signature-research.md` and `external-anchors/*.json` in this autoresearch folder.
